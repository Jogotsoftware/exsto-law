...
// Skipped without a connection string. Assumes the vertical migrations (0101–0106)
// + seed are applied — i.e. the platform admin (0102) is present.
...
const PLATFORM_ADMIN_ACTOR = '00000000-0000-0000-00FF-00000000000a' // seeded by 0102
