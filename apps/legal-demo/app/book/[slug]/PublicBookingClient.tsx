...
// page (moved verbatim out of page.tsx for HOST-TENANCY-1: the route now has a
// server shell that redirects firm-host traffic before this ever renders).
// A prospect opens the firm's link (/book/{slug}), sees the firm's REAL
