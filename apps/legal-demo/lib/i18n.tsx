...
const en: Record<string, string> = {
  ...
  'error.mailing_address': 'Please enter your mailing address.',
  'error.business_name': 'Please enter the business name.',
  'error.business_address': 'Please enter the business address.',
  ...
  // Sign-up "details" step (client address + business + preferred contact).
  'details.heading': 'A few more details',
  'details.subtitle': 'This helps us prepare your documents correctly.',
  'details.section_you': 'Your details',
  'details.mailing_address': 'Mailing address',
  'details.preferred_contact': 'Preferred contact method',
  'details.contact_email': 'Email',
  'details.contact_phone': 'Phone call',
  'details.contact_text': 'Text message',
  'details.is_business': 'This is for a business',
  'details.business_name': 'Business name',
  'details.business_same': 'Business address is the same as my mailing address',
  'details.business_address': 'Business address',
  ...
  'portal.nav.pin': 'Pin sidebar open',
  'portal.nav.unpin': 'Unpin sidebar',
...
const es: Record<string, string> = {
  ...
  'error.mailing_address': 'Por favor ingresa tu dirección postal.',
  'error.business_name': 'Por favor ingresa el nombre del negocio.',
  'error.business_address': 'Por favor ingresa la dirección del negocio.',
  ...
  // Paso de "datos" del registro (dirección + negocio + contacto preferido).
  'details.heading': 'Unos datos más',
  'details.subtitle': 'Esto nos ayuda a preparar tus documentos correctamente.',
  'details.section_you': 'Tus datos',
  'details.mailing_address': 'Dirección postal',
  'details.preferred_contact': 'Método de contacto preferido',
  'details.contact_email': 'Correo electrónico',
  'details.contact_phone': 'Llamada telefónica',
  'details.contact_text': 'Mensaje de texto',
  'details.is_business': 'Esto es para un negocio',
  'details.business_name': 'Nombre del negocio',
  'details.business_same': 'La dirección del negocio es la misma que mi dirección postal',
  'details.business_address': 'Dirección del negocio',
  ...
  'portal.nav.pin': 'Fijar el menú abierto',
  'portal.nav.unpin': 'Soltar el menú',
