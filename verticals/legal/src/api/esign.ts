...
// tenant zero keeps its historical …0005 public-intake actor; every other
// tenant uses its own system/agent actor (resolvePublicIntakeActor — the same
// seam the public booking funnel was moved to in MULTI-TENANT-1). A module-
// level hardcode would attribute a second firm's signatures to tenant zero's
// actor. Cached per tenant: actors are stable and the sign routes resolve this
