-- =============================================================================
-- Vertical migration 0094: seed the first platform admin (ADR 0046)
--
-- The platform tenant + its system actor ship in 0093. This seeds the founder as
...
--
-- Idempotent: fixed UUIDs + ON CONFLICT DO NOTHING. Number 0094 = next after 0093.
-- =============================================================================
