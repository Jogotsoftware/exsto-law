-- =============================================================================
-- Vertical migration 0113: Signature tasks
--
...
--
-- Id block c0 (attribute 1011, relationship 1012, action 1013): verified free on
-- origin/main migration files (max 0112) AND the live prod ledger (max 0109).
...
INSERT INTO attribute_kind_definition
  ...
  ('00000000-0000-0000-1011-000000000c02', '00000000-0000-0000-0000-000000000001',
   ...
   '00000000-0000-0000-1010-000000000900', 'text', false),
  ('00000000-0000-0000-1011-000000000c03', '00000000-0000-0000-0000-000000000001',
...
INSERT INTO relationship_kind_definition
  ...
  ('00000000-0000-0000-1012-000000000c00', '00000000-0000-0000-0000-000000000001',
...
INSERT INTO action_kind_definition
  ...
  ('00000000-0000-0000-1013-000000000c01', '00000000-0000-0000-0000-000000000001',
   ...
   'notify', 'fully_reversible', NULL, false),
  ('00000000-0000-0000-1013-000000000c02', '00000000-0000-0000-0000-000000000001',
